...
ComputeStyle(dijkstra/atom,ComputeDijkstraAtom)

#else

#ifndef LMP_COMPUTE_DIJKSTRA_ATOM_H
#define LMP_COMPUTE_DIJKSTRA_ATOM_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeDijkstraAtom : public Compute {
 public:
  ComputeDijkstraAtom(class LAMMPS *, int, char **);
  ~ComputeDijkstraAtom();
  void init();
